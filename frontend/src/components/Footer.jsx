        ...
        <div className=" bg-gray-100">
            <div className="w-full border-gray-100 border-t lg:w-11/12 md:w-11/12 lg:mx-auto md:mx-auto">
                <div className="container mx-auto py-6">
                    ...
                    <div className="xl:flex flex-wrap justify-between xl:mt-14 mt-6 pb-6 pl-3 sm:pl-0">
                        <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0">
                            <p className="text-gray-800 text-base">{year} Luciano Aguirre. All Rights Reserved</p>
                        </div>
