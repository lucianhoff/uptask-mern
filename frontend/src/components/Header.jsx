                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex">
                                <div className="hidden xl:flex md:mr-6 xl:mr-16">
                                    <Link to="/projects" className="flex px-5 items-center py-6 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none transition duration-150 ease-in-out">
                                        <span className="mr-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                <rect x={4} y={4} width={6} height={6} rx={1} />
                                ...
                                <div className="hidden xl:flex items-center">
                                    <div className="relative md:mr-6 my-2">
                                        <Link to="/projects/newproject" className="focus:outline-none bg-indigo-700 border-gray-300 border transition duration-150 ease-in-out hover:bg-indigo-500 rounded text-white px-5 py-2 text-xs">Create Project</Link>
                                    </div>
                    ...
                    <div className="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-white fixed top-0 z-40">
                        ...
                        <div className="flex items-center">
                            <div className="relative mr-6 ">
                                <button  className="focus:outline-none bg-indigo-700 border-gray-300 border transition duration-150 ease-in-out hover:bg-indigo-500 rounded text-white px-5 py-2 text-xs">Create Project</button>
                            </div>
